...
o.bind("SUPER + SHIFT + SLASH",   "Passwords",        "uwsm app -- 1password --quick-access")
o.bind("SUPER + SHIFT + ALT + SLASH", "1Password",    "uwsm app -- 1password")
o.bind("SUPER + SHIFT + Y",       "YouTube",          'omarchy-launch-webapp "https://youtube.com/" --profile-directory="Default"')
o.bind("SUPER + SHIFT + R",       "Lanvera VDI",      'omarchy-launch-webapp "https://client.wvd.microsoft.com/arm/webclient/index.html" --profile-directory="Profile 3"')
o.bind("SUPER + SHIFT + ALT + R", "Pythian Notebook", desktop)
